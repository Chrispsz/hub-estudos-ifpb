...
export const disciplines: Discipline[] = [
  ...
  },
  {
    ...
    ordemEstudo: [
      ...
      '5. Comece o projeto A1 imediatamente (estrutura HTML)',
      '6. Depois das listas, estude CSS (seletores, box model)',
      '7. Faça o A2 (CSS) - use Flexbox/Grid',
      '8. Prepare a apresentação A3 com antecedência',
    ],
    datasImportantes: [
      { data: 'Semana 6', descricao: 'A1 - Estrutura do website (HTML) - peso 45%' },
      { data: 'Semana 12', descricao: 'A2 - Codificação visual (CSS) - peso 45%' },
      { data: 'Semana 16', descricao: 'A3 - Apresentação do projeto - peso 10%' },
    ],
  },
  {
    code: 'TEC.1984',
    ...
    datasImportantes: [
      { data: 'Semana 5', descricao: 'Av1 - Álgebra Matricial' },
      { data: 'Semana 10', descricao: 'Av2 - Lógica Matemática' },
      { data: 'Semana 16', descricao: 'Av3 - Conjuntos, Funções + trabalho' },
    ],
  },
  {
    code: '53647',
