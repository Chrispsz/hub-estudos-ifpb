...
export const exercises: Exercise[] = [
  ...
  // ===== Questões da Semana 3 (Classroom, 23/09) — 100% desvios condicionais =====
  {
    id: 'alg-s3q1',
    disciplineCode: 'TEC.1687',
    topic: 'Desvios condicionais',
    statement: 'Q1 (Semana 3): Escreva um programa que leia um número inteiro e determine o seu valor absoluto. O valor absoluto deve ser calculado sem o uso de qualquer função oferecida pela linguagem.',
    difficulty: 'facil',
    source: 'lista_algoritmos',
    unit: 'Unidade 2: Desvios condicionais',
    linkedMaterials: ['alg-questoes-semana3'],
    hint: 'A questão PROÍBE fabs()/abs(). A decisão é sua: if (n < 0) n = -n; — negar é multiplicar por -1.',
  },
  {
    id: 'alg-s3q2',
    disciplineCode: 'TEC.1687',
    topic: 'Desvios condicionais',
    statement: 'Q2 (Semana 3): Escreva um programa que leia o número de gols marcados pelo time da casa e o número de gols marcado pelo time visitante e verifique se o jogo foi vencido pelo time da casa, pelo time visitante ou se terminou empatado.',
    difficulty: 'facil',
    source: 'lista_algoritmos',
    unit: 'Unidade 2: Desvios condicionais',
    linkedMaterials: ['alg-questoes-semana3'],
    hint: 'Três saídas mutuamente exclusivas: if (casa > visitante) … else if (visitante > casa) … else (empate). Inteiros, sem pegadinha.',
  },
  {
    id: 'alg-s3q3',
    disciplineCode: 'TEC.1687',
    topic: 'Desvios condicionais',
    statement: 'Q3 (Semana 3): Escreva um programa que leia a idade de uma pessoa e verifique se ela é criança (0-12 anos), adolescente (13-17 anos), adulta (18-59) ou idosa (acima de 60 anos).',
    difficulty: 'facil',
    source: 'lista_algoritmos',
    unit: 'Unidade 2: Desvios condicionais',
    linkedMaterials: ['alg-questoes-semana3'],
    hint: 'ARMADILHA DE BORDA: "idosa (acima de 60)" → 60 exato ainda é ADULTO. Cadeia: idade <= 12 → … <= 17 → … <= 59 ou <= 60 → senão idosa. Leia o enunciado, não a intuição.',
  },
  {
    id: 'alg-s3q4',
    disciplineCode: 'TEC.1687',
    topic: 'Desvios condicionais',
    statement: 'Q4 (Semana 3): Escreva um programa que leia o valor de um ano e verifique se ele é ou não bissexto. Um ano é bissexto se ele for divisível por quatrocentos ou se se ele for divisível por 4 mas não for divisível por 100.',
    difficulty: 'medio',
    source: 'lista_algoritmos',
    unit: 'Unidade 2: Desvios condicionais',
    linkedMaterials: ['alg-questoes-semana3'],
    hint: 'A clássica: ano % 400 == 0 || (ano % 4 == 0 && ano % 100 != 0). Teste mental: 2024 bissexto, 2100 NÃO (÷100 sem ÷400), 2000 SIM (÷400).',
  },
  {
    id: 'alg-s3q5',
    disciplineCode: 'TEC.1687',
    topic: 'Desvios condicionais',
    statement: 'Q5 (Semana 3): Escreva um programa que leia as coordenadas x e y de um ponto e verifique a quantidade de quadrantes a que este ponto pertence.',
    difficulty: 'medio',
    source: 'lista_algoritmos',
    unit: 'Unidade 2: Desvios condicionais',
    linkedMaterials: ['alg-questoes-semana3'],
    hint: 'É QUANTIDADE, não qual: dentro → 1 quadrante; sobre um eixo (x==0 ou y==0) → 2; na origem (0,0) → 4. Teste o zero ANTES do sinal.',
  },
  {
    id: 'alg-s3q6',
    disciplineCode: 'TEC.1687',
    topic: 'Desvios condicionais',
    statement: 'Q6 (Semana 3): Escreva um programa que leia três números inteiros distintos e identifique o maior número informado.',
    difficulty: 'facil',
    source: 'lista_algoritmos',
    unit: 'Unidade 2: Desvios condicionais',
    linkedMaterials: ['alg-questoes-semana3'],
    hint: 'O enunciado GARANTE distintos → nada de ==. Suponha maior = a; if (b > maior) maior = b; if (c > maior) maior = c;',
  },
  {
    id: 'alg-s3q7',
    disciplineCode: 'TEC.1687',
    topic: 'Desvios condicionais',
    statement: 'Q7 (Semana 3): Escreva um programa que leia os valores dos três ângulos internos de um triângulo e verifique se o mesmo é um triângulo retângulo.',
    difficulty: 'medio',
    source: 'lista_algoritmos',
    unit: 'Unidade 2: Desvios condicionais',
    linkedMaterials: ['alg-questoes-semana3'],
    hint: 'Dois testes: soma == 180 (validade) E algum ângulo == 90 em QUALQUER posição: (a1 == 90 || a2 == 90 || a3 == 90).',
  },
  {
    id: 'alg-s3q8',
    disciplineCode: 'TEC.1687',
    topic: 'Desvios condicionais',
    statement: 'Q8 (Semana 3): Alfredo tem um carro flex e sempre fica na dúvida se é melhor abastecê-lo com álcool ou gasolina. Um dia um de seus amigos o ensinou a seguinte dica: "Pegue o valor do preço da gasolina e multiplique por 0,7. Se o valor for menor ou igual ao valor do preço do álcool, abasteça com gasolina. Caso contrário, abasteça com álcool." Com base nestas informações, escreva um programa que leia o preço do litro da gasolina e do álcool e verifique se é melhor abastecer com álcool ou com gasolina.',
    difficulty: 'facil',
    source: 'lista_algoritmos',
    unit: 'Unidade 2: Desvios condicionais',
    linkedMaterials: ['alg-questoes-semana3'],
    hint: 'Siga a dica À RISCA: if (gasolina * 0.7 <= alcool) → GASOLINA; senão → ÁLCOOL. Quem rende 70% é o etanol — a conta é no preço da gasolina. Preços em double.',
  },
